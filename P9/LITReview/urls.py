...
urlpatterns = [
    ...
    path(
        'follow-user/delete-followed-user/<int:user_id>/',
        blog.views.delete_followed_user,
        name='delete_followed_user'
    ),
    path(
        'ticket/<int:ticket_id>/',
        blog.views.view_ticket,
        name='view_ticket'
    ),
    path(
        'ticket/create/',
    ...
    path(
        ...
        blog.views.view_review,
        name='view_review'
    ),
    path(
        'review/create/review-without-ticket/',
        blog.views.create_review_without_ticket,
